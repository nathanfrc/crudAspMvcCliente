...
namespace CrudAspNetMvc.Controllers
{
    public class ClienteController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nome,Documento,Telefone,Data")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nome,Documento,Telefone,Data")] Cliente cliente)
        {
            if (ModelState.IsValid)
            {
